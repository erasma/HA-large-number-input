 ...
 * Lovelace card delivering an oversized numeric input for number and input_number entities.
 */
class LargeNumberInputCard extends LitElement {
  ...
  render() {
    ...
    if (!stateObj) {
      return html`<ha-card><div class="header">${this._config.name ?? this._config.entity}</div><p>Entity not found.</p></ha-card>`;
    }
